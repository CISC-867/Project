# https://github.com/dunbar12138/Audiovisual-Synthesis/blob/master/model_vc.py#L524
...
class Generator(nn.Module):
    ...
    def train_step(
        ...
        y_pred_spectro = self.encoder(x)
        y_pred_spectro = self.decoder(y_pred_spectro)

        loss_spectro = self.criterionIdt(x, y_pred_spectro)
        ...
        loss_vocoder = self.vocoder_loss_func(y_pred_wav, wav.unsqueeze(-1).to(device))
        total_loss = loss_spectro  + self.lambda_wavenet * loss_vocoder
